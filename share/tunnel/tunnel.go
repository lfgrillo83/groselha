...
// Both groselha client and server are Tunnels.
// groselha client has a single set of remotes, whereas
// groselha server has multiple sets of remotes (one set per client).
